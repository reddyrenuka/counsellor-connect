        ...
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl shadow-lg p-8 border border-indigo-100">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-shrink-0 mx-auto md:mx-0">
              <div className="w-56 h-56 bg-gradient-to-br from-indigo-200 to-purple-200 rounded-lg flex items-center justify-center shadow-md">
                <div className="text-center text-gray-600">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 mx-auto mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
